...
namespace PR_2._3
{
     public class PassengerCarriage: Carriage
    {
        ...
        public bool AreThereFreeSeats(int count)
        {
            ...
            {
                Console.WriteLine($"В вагоні немає вільних місць для {count} пасажирів. Доступно лише {SeatsCount - PassengersCount} вільних місць.Решта студентів залишилась за вікном");
                return false;
            }
        }
    }
